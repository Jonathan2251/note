...
export GNU_SRC_DIR=$HOME/riscv/git/13.0.0
export LLVM_SRC_DIR=$HOME/riscv/git/13.0.0

export GNU_NEWLIB_INSTALL_DIR=$HOME/riscv/13.0.0/riscv_newlib
export LLVM_NEWLIB_BUILD_DIR=$LLVM_SRC_DIR/llvm-project/build_riscv_newlib

export GNU_LINUX_INSTALL_DIR=$HOME/riscv/13.0.0/riscv_linux
