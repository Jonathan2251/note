; ~/andes/riscv/git/Phoenix/llvm-project/build_riscv_newlib/bin/llc -mtriple=riscv64 test_fail_ace2.ll -debug -print-before-all -o -

; ModuleID = 'test_fail_ace2.c'
source_filename = "test_fail_ace2.c"
